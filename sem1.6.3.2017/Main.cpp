...
int main() {
	...
	*/
	...
	Vozidlo* vozidlo1 = new Vozidlo("abcd123", 6.6, "05.05.2015");
	Vozidlo* vozidlo2 = new Vozidlo("efgh123", 2.6, "25.05.2016");
	...
	Paleta* paleta1 = new Paleta(1, 7.5, true, dod1);
	Paleta* paleta2 = new Paleta(4, 11.8, true,dod1);
	Kamion* kamion = new Kamion("01.01.2017");
	kamion->getObsah()->add(paleta1);
	kamion->getObsah()->add(paleta2);
	Paleta* paleta3 = new Paleta(3, 1.2, true,dod1);
	cout << paleta3->getDatumDorucenia() << endl;
	Paleta* paleta4 = new Paleta(1, 12.9, false, dod1);
	Paleta* paleta5 = new Paleta(2, 2.1, true, dod1);
	Paleta* paleta6 = new Paleta(3, 6.1, false, dod1);
