...
int main() {
	...
	*/
	...
	Vozidlo* vozidlo3 = new Vozidlo("ijkl123", 29.6, "04.01.2017");
	...
	Paleta* paleta6 = new Paleta(2, 23.1, true, "20.03.2017", dod1);
	Paleta* paleta7 = new Paleta(1, 3.4, true, "20.03.2017", dod1);
